...
class EnvironmentViewModel: ObservableObject {
    ...
    func  getData(){
//        self.dataArrey.append("iPhone")
//        self.dataArrey.append("iPad")
//        self.dataArrey.append("iWatch")
        self.dataArrey.append(contentsOf: ["iPhone","iPad","iMac","Apple Watch"])
    }
}
...
struct EnvironmentObjectBootcamp: View {
    ...
    var body: some View {
        NavigationView{
            List{
                ForEach(viewModel.dataArrey, id: \.self ) { item in
                    NavigationLink(
